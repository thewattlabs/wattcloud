...
<div class="scanner-wrap">
  ...
  {:else if permissionDenied}
    <div class="overlay denied">
      ...
      <p class="status-sub">Enable camera permissions for this site, then reload — or paste your code below.</p>
    </div>
  {:else}
    <!-- Viewfinder overlay -->
...
{#if showManualEntry}
  <div class="manual-entry">
    <label class="input-label" for="qr-manual-input">Paste or type the enrollment code</label>
    <input
      id="qr-manual-input"
      class="input"
