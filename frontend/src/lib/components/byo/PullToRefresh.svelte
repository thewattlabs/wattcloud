<!--
  ...
  "Cloud Spin" replacing the generic circular spinner.
  ...
  2. Pull distance maps to a 0..1 progress that drives the cloud path's
     stroke-dashoffset (so the outline draws itself as the user pulls).
  3. If the user releases past the 48dp threshold, the cloud rotates
