...
<div class="sas-wrap">
  <div class="sas-hex" aria-hidden="true">
    <CloudBadge size={40} variant="outline" />
  </div>
  ...
  <p class="sublabel">
    Both devices must show the same code. If they differ, abort — it means the channel is compromised.
  </p>
